...
{
	auto iter = std::find(mMeshComps[mesh->GetShaderName()].begin(), mMeshComps[mesh->GetShaderName()].end(), mesh);
	mMeshComps[mesh->GetShaderName()].erase(iter);
}
